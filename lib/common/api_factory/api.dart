...
import 'package:meditation_app/common/api_factory/api_end_points.dart';
import 'package:meditation_app/common/api_factory/dio_factory.dart';
import 'package:meditation_app/common/api_factory/models/version_info_response.dart';
...
class Api {
    ...
    request(
      ...
      onResponse: (response) {
        if (response != null) {
          ...
          print(response);
          showWarningForce("Email atau Password Salah");
        }
      },
      onError: (error, data) {
        onError(error, {});
  ...
  static forgotPassword({
    ...
    var params = {"email": email, "context": {}};
  ...
  static signUp({
    required String username,
    required String emailout,
    required OnResponse onResponse,
    required OnError onError,
  }) {
    var params = {"name": username, "login": emailout, "context": {}};
    ...
    request(
      ...
      onResponse: (response) {
        if (response != null) {
          ...
          // print(response);
          // hideLoading();
          return showWarningForce("Email sudah terdaftar");
        }
      },
      onError: (error, data) {
        onError(error, {});
